...
def play_warning_sound():
    frequency = 2500  # Warning sound frequency
    duration = 1000  # Warning sound duration in milliseconds
    winsound.Beep(frequency, duration)

# main
cap = cv2.VideoCapture(0)  # 0 corresponds to the default camera (webcam)

# Increase the webcam video size
